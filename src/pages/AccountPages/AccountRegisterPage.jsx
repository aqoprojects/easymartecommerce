...
const AccountRegisterPage = () => {
  return (
    ...
    <main className='flex  justify-center-safe'>
      ...
      <section className='flex-1 max-w-110 mt-4 md:mt-10 px-2'>
        <div className='mb-10'>
        ...
        <div  className='bg-black/2 p-6 rounded-2xl mb-10'>
          ...
          <div>
            <div>
              <p className='font-semibold text-lg mb-1'>Full name</p>
              <input type="text" className='ring-1 ring-black/10 w-full py-3 px-4 bg-white rounded-lg mb-4' placeholder='Fullname' />
            </div>
            <div>
              <p className='font-semibold text-lg mb-1'>Email</p>
              <input type="text" className='ring-1 ring-black/10 w-full py-3 px-4 bg-white rounded-lg mb-4' placeholder='Email' />
            </div>
            <div>
              <p className='font-semibold text-lg mb-1'>Passowrd</p>
              <input type="text" className='ring-1 ring-black/10 w-full py-3 px-4 bg-white rounded-lg mb-8' placeholder='Passowrd' />
            </div>
             <button className="bg-[#B6349A] text-white flex gap-2 py-2.5 w-full px-8 justify-center-safe items-center-safe font-semibold text-lg rounded-4xl">Coutinue  </button>
          </div>
        ...
        <div className='flex flex-col gap-4'>
           <button className="bg-black/4 text-[#B6349A] flex gap-3 py-2.5 w-full px-8 justify-center-safe items-center-safe font-semibold text-lg rounded-4xl "> <FaMeta className="size-5" /> Sign up with Meta</button>
            ...
            <p className='font-semibold text-lg text-center mt-4'>Already have an account? <span className='text-[#B6349A]'>Login</span> </p>
        </div>
      </section>
    </main>
    </>
